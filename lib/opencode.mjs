...
export async function importOpencodeFile(ctx, target, args, { registryDir, persisted, runDecision, markTrimmedSource, filter, convert = convertOpencodeJson, readDb = readOpencodeDb } = {}) {
